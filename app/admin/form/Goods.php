            ...
            'form' => [
                ...
                [
                    ...
                    'search_config'     => [
                        ...
                        'placeholder'         => '请输入商品名称/简述',//$lang['info_placeholder'],
                    ],
                ],
                [
                ...
                [
                    ...
                    'view_type'         => 'field',
                    'view_key'          => 'supplier_name',
                    'params_where_name' => 'supplier_ids',
                    'is_sort'           => 1,
                    'is_detail'         => 1,
                    'width'             => 140,
                    'is_list'           => 1,
                    'search_config'     => [
                        'form_type'         => 'select',
                        'form_name'         => 'supplier_id',
                        'where_type'        => 'in',
                        'data'              => SupplierService::CategorySupplier(),
                        'data_key'          => 'id',
                        'data_name'         => 'name',
                        'is_multiple'       => 1,
                    ],
