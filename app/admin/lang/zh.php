...
return [
    ...
    'site'                  => [
        ...
        'base_item_trace_source_title'          => '指定品类订单溯源',
        ...
        // 备案信息表单
        'form_filing_title'                        => '备案信息',
        'form_filing_icon'                         => '图标',
        'form_filing_icon_tips'                    => '建议60*60px',
        'form_filing_name'                         => '名称',
        'form_filing_name_message'                 => '名称格式1~100个字符之间',
        'form_filing_show_name'                    => '展示名称',
        'form_filing_show_name_message'            => '展示名称格式1~300个字符之间',
        'form_filing_url'                          => 'url地址',
        'form_filing_url_message'                  => '请填写正确的url地址',
        // 域名绑定语言
    ...
    'warehouse'             => [
        'base_nav_title'                        => '仓库',
        'top_tips_list'                         => [
            '1. 仓库分配扣除库存顺序优先级：订单地址坐标(升序) -> 用户当前坐标(升序) -> 权重值(降序) -> 默认仓库(降序) -> 库存数量(降序)',
    ...
    'order'                 => [
        ...
        'form_item_service_add_name'                  => '添加服务',
        'form_item_service_fill_win_name'             => '填写服务',
        ...
        'form_table'                            => [
            ...
            'client_type'                      => '来源',
            'address'                          => '地址信息',
            'address_contact_name'             => '地址联系人',
            'address_contact_tel'              => '地址联系电话',
            'address_extraction_contact_name'  => '地址自提联系人',
            'address_extraction_contact_tel'   => '地址自提联系电话',
            'address_info'                     => '地址信息',
            'service'                          => '服务信息',
            'take'                             => '取货信息',
            'refund_price'                     => '退款金额',
        ...
        'detail_form_list'                      => [
            ...
            'address_data' => [
                ...
                'data' => [
                    ...
                    'lat'                      => '坐标纬度',
                    'appoint_time'             => '预约时间',
                    'extraction_contact_name'  => '自提联系人',
                    'extraction_contact_tel'   => '自提联系电话',
                    'idcard_name'              => '身份证姓名',
                    'idcard_number'            => '身份证号码',
                    'idcard_front'             => '身份证正面图片',
                    'idcard_back'              => '身份证背面图片',
                ],
            ],
            'express_data' => [
            ...
            'service_data' => [
                ...
                'data' => [
                    ...
                    'user_id'                       => '用户id',
                    'service_name'                  => '服务联系人',
                    'service_mobile'                => '服务联系电话',
                    'service_start_time'            => '服务开始时间',
                    'service_end_time'              => '服务结束时间',
                    'service_duration_minute_text'  => '服务时长',
                    'note'                          => '备注信息',
                ],
            ],
            'extension_data' => [
    ...
    'orderaftersale'        => [
        ...
        'form_table'                            => [
            ...
            'goods_images'       => '商品封面',
            'goods_price'        => '商品售价',
            'goods_buy_number'   => '商品购买数量',
            'goods_spec_text'    => '商品购买规格',
            'goods_url'          => '商品链接地址',
            'user_id'            => '用户ID',
            'user_username'      => '用户名',
            'user_nickname'      => '用户昵称',
    ...
    // form表单
    'forminput'                   => [
        'nav_store_forminput_name'              => '更多form表单板下载',
        'upload_list_tips'                      => [
            '1. 选择已下载的form表单设计zip包',
            '2. 导入将自动新增一条数据',
        ],
        // 动态表格
        'form_table'                            => [
    ...
    'searchhistory'         => [
        ...
        'form_table'                            => [
            ...
            'supplier_text'           => '供货商',
            'category_text'           => '商品分类',
            'screening_price_values'  => '价格范围',
            'produce_region_text'     => '生产地',
            'goods_params_values'     => '商品参数',
            'goods_spec_values'       => '商品规格',
            'order_by_field'          => '排序字段',
            'order_by_type'           => '排序类型',
            'search_result'           => '搜索结果',
            'ip'                      => '用户IP',
    ...
    'common'                => [
        ...
        'form_goods_params_thead_scope_title'      => '展示范围',
        'form_goods_params_thead_name_title'       => '参数名称',
        'form_goods_params_thead_required_title'   => '是否必须',
        'form_goods_params_thead_data_type_title'  => '数据类型',
    ...
    'admin_power_menu_list' => [
        ...
        'websiteadmin_index' => [
            ...
            'item'  => [
                ...
                'attachmentapi_category'           => '附件Api-附件分类',
                'attachmentapi_list'               => '附件Api-附件列表',
                'attachmentapi_save'               => '附件Api-附件保存',
                'attachmentapi_delete'             => '附件Api-附件删除',
                'attachmentapi_upload'             => '附件Api-附件上传',
                'attachmentapi_catch'              => '附件Api-附件远程下载',
                'attachmentapi_scanuploaddata'     => '附件Api-附件扫码上传数据',
                'attachmentapi_movecategory'       => '附件Api-附件移动分类',
                'attachmentapi_categorysave'       => '附件Api-附件分类保存',
                'attachmentapi_categorydelete'     => '附件Api-附件分类删除',
            ]
        ],
        'brand_index' => [
            'name'  => '品牌',
        ...
        'app_index' => [
            ...
            'item'  => [
                ...
                'diyapi_apptabbarsave'             => 'DIY装修-底部菜单保存',
                'diyapi_apptabbardata'             => 'DIY装修-底部菜单数据',
