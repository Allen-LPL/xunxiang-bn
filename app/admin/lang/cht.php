...
return [
    ...
    'site'                  => [
        ...
        'base_item_trace_source_title'          => '指定品類訂單溯源',
        ...
        'add_self_extraction_address_title'     => '添加地址',
        'add_filing_title'                      => '添加備案',
        'siteset_trace_source_required_list'    => [
            'code'                 => '追溯碼',
            'batch_number'         => '批號',
            'batch_number_expire'  => '批號有效期',
        ],
        ...
        // 备案信息表单
        'form_filing_title'                        => '備案資訊',
        'form_filing_icon'                         => '圖標',
        'form_filing_icon_tips'                    => '建議60*60px',
        'form_filing_name'                         => '名稱',
        'form_filing_name_message'                 => '名稱格式1~100個字元之間',
        'form_filing_show_name'                    => '展示名稱',
        'form_filing_show_name_message'            => '展示名稱格式1~300個字元之間',
        'form_filing_url'                          => 'url地址',
        'form_filing_url_message'                  => '請填寫正確的url地址',
        // 域名绑定语言
    ...
    'warehouse'             => [
        'base_nav_title'                        => '倉庫',
        'top_tips_list'                         => [
            '倉庫分配扣除庫存順序優先順序：訂單地址座標（昇冪）->用戶當前座標（昇冪）->權重值（降序）->默認倉庫（降序）->庫存數量（降序）',
    ...
    'order'                 => [
        ...
        'form_item_service_add_name'                  => '添加服務',
        'form_item_service_fill_win_name'             => '填寫服務',
        ...
        'form_table'                            => [
            ...
            'client_type'                      => '來源',
            'address'                          => '地址資訊',
            'address_contact_name'             => '地址連絡人',
            'address_contact_tel'              => '地址聯繫電話',
            'address_extraction_contact_name'  => '地址自提連絡人',
            'address_extraction_contact_tel'   => '地址自提聯繫電話',
            'address_info'                     => '地址資訊',
            'service'                          => '服務資訊',
            'take'                             => '取貨資訊',
            'refund_price'                     => '退款金額',
        ...
        'detail_form_list'                      => [
            ...
            'address_data' => [
                ...
                'data' => [
                    ...
                    'lat'                      => '坐標緯度',
                    'appoint_time'             => '預約時間',
                    'extraction_contact_name'  => '自提聯繫人',
                    'extraction_contact_tel'   => '自提聯繫電話',
                    'idcard_name'              => '身份證姓名',
                    'idcard_number'            => '身份證號碼',
                    'idcard_front'             => '身份證正面圖片',
                    'idcard_back'              => '身份證背面圖片',
                ],
            ],
            'express_data' => [
            ...
            'service_data' => [
                ...
                'data' => [
                    ...
                    'user_id'                       => '用戶id',
                    'service_name'                  => '服務聯繫人',
                    'service_mobile'                => '服務聯繫電話',
                    'service_start_time'            => '服務開始時間',
                    'service_end_time'              => '服務結束時間',
                    'service_duration_minute_text'  => '服務時長',
                    'note'                          => '備註資訊',
                ],
            ],
            'extension_data' => [
    ...
    'orderaftersale'        => [
        ...
        'form_table'                            => [
            ...
            'goods_images'       => '商品封面',
            'goods_price'        => '商品售價',
            'goods_buy_number'   => '商品購買數量',
            'goods_spec_text'    => '商品購買規格',
            'goods_url'          => '商品連結地址',
            'user_id'            => '用戶ID',
            'user_username'      => '用戶名',
            'user_nickname'      => '用戶暱稱',
    ...
    // form表单
    'forminput'                   => [
        'nav_store_diy_name'                    => '更多form表單板下載',
        'upload_list_tips'                      => [
            '1. 選擇已下載的form表單設計zip包',
            '2. 導入將自動新增一條數據',
        ],
        // 动态表格
        'form_table'                            => [
    ...
    'searchhistory'         => [
        ...
        'form_table'                            => [
            ...
            'supplier_text'           => '供货商',
            'category_text'           => '商品分類',
            'screening_price_values'  => '價格範圍',
            'produce_region_text'     => '生產地',
            'goods_params_values'     => '商品參數',
            'goods_spec_values'       => '商品規格',
            'order_by_field'          => '排序欄位',
            'order_by_type'           => '排序類型',
            'search_result'           => '搜索結果',
            'ip'                      => '用戶IP',
    ...
    'common'                => [
        ...
        'form_goods_params_thead_scope_title'      => '展示範圍',
        'form_goods_params_thead_name_title'       => '參數名稱',
        'form_goods_params_thead_required_title'   => '是否必須',
        'form_goods_params_thead_data_type_title'  => '資料類型',
    ...
    'admin_power_menu_list' => [
        ...
        'websiteadmin_index' => [
            ...
            'item'  => [
                ...
                'themedata_detail'                 => '主題數據詳情',
                'themedata_goodssearch'            => '主題數據商品搜索',
                'themedata_articlesearch'          => '主題數據文章搜索',
                'slide_index'                      => '首頁輪播',
                ...
                'forminput_index'                  => 'Form表单',
                'forminput_detail'                 => 'Form表单详情',
                'forminput_preview'                => 'Form表单预览',
                'forminput_saveinfo'               => 'Form表单添加/编辑页面',
                'forminput_save'                   => 'Form表单添加/编辑',
                'forminput_statusupdate'           => 'Form表单状态更新',
                'forminput_delete'                 => 'Form表单删除',
                'forminput_download'               => 'Form表单下载',
                'forminput_upload'                 => 'Form表单导入',
                'forminput_market'                 => 'Form表单模板市场',
                'forminput_storeupload'            => 'Form表单上传商店',
                'forminput_storeuploadinfo'        => 'Form表单上传商店页面',
                'forminputdata_index'              => 'Form表单数据',
                'forminputdata_detail'             => 'Form表单数据详情',
                'forminputdata_delete'             => 'Form表单数据删除',
                'forminputapi_init'                => 'Form表单Api-公共初始化',
                'forminputapi_forminputlist'       => 'Form表单Api-列表',
                'forminputapi_forminputdetail'     => 'Form表单Api-详情',
                'forminputapi_forminputsave'       => 'Form表单Api-保存',
                'forminputapi_forminputupload'     => 'Form表单Api-导入',
                'forminputapi_forminputdownload'   => 'Form表单Api-导出',
                'forminputapi_forminputinstall'    => 'Form表单Api-模板安装',
                'forminputapi_forminputmarket'     => 'Form表单Api-模板市场',
                ...
                'attachmentapi_index'              => '附件Api',
                'attachmentapi_category'           => '附件Api-附件分類',
                'attachmentapi_list'               => '附件Api-附件清單',
                'attachmentapi_save'               => '附件Api-附件保存',
                'attachmentapi_delete'             => '附件Api-附件删除',
                'attachmentapi_upload'             => '附件Api-附件上傳',
                'attachmentapi_catch'              => '附件Api-附件遠程下載',
                'attachmentapi_scanuploaddata'     => '附件Api-附件掃碼上傳數據',
                'attachmentapi_movecategory'       => '附件Api-附件移動分類',
                'attachmentapi_categorysave'       => '附件Api-附件分類保存',
                'attachmentapi_categorydelete'     => '附件Api-附件分類删除',
            ]
        ],
        'brand_index' => [
            'name'  => '品牌',
        ...
        'supplier_index' => [
            'name'  => '供货商',
            'item'  => [
                'supplier_index'           => '供货商管理',
                'supplier_saveinfo'        => '供货商添加/编辑页面',
                'supplier_save'            => '供货商添加/编辑',
                'supplier_statusupdate'    => '供货商状态更新',
                'supplier_delete'          => '供货商删除',
                'supplier_detail'          => '供货商详情',
            ]
        ],
        'warehouse_index' => [
            'name'  => '倉庫',
        ...
        'app_index' => [
            ...
            'item'  => [
                ...
                'diyapi_apptabbarsave'             => 'DIY裝修-底部選單保存',
                'diyapi_apptabbardata'             => 'DIY裝修-底部選單數據',
