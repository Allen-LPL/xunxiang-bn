...
return [
    ...
    'site'                  => [
        ...
        'base_item_trace_source_title'          => 'Trazabilidad de los pedidos de las categorías designadas',
        ...
        'add_self_extraction_address_title'     => 'Añadir dirección',
        'add_filing_title'                      => 'Añadir registro',
        'siteset_trace_source_required_list'    => [
            'code'                 => 'Código de Seguimiento',
            'batch_number'         => 'Número de Lote',
            'batch_number_expire'  => 'Plazo de Validez del Número de Lote',
        ],
        ...
        // 备案信息表单
        'form_filing_title'                        => 'Información de registro',
        'form_filing_icon'                         => 'Iconos',
        'form_filing_icon_tips'                    => 'Recomendación 60 * 60 px',
        'form_filing_name'                         => 'nombre',
        'form_filing_name_message'                 => 'Formato de nombre entre 1 y 100 caracteres',
        'form_filing_show_name'                    => 'Nombre de la pantalla',
        'form_filing_show_name_message'            => 'Mostrar formato de nombre entre 1 y 300 caracteres',
        'form_filing_url'                          => 'Dirección URL',
        'form_filing_url_message'                  => 'Por favor, rellene la dirección URL correcta.',
        // 域名绑定语言
    ...
    'warehouse'             => [
        ...
        'top_tips_list'                         => [
            '1. Asignación de almacén deduciendo prioridad de orden de inventario: coordenadas de dirección de pedido (orden ascendente) - > coordenadas actuales del usuario (orden ascendente) - > valor de peso (orden descendente) - > almacén predeterminado (orden descendente) - > cantidad de inventario (orden descendente)',
    ...
    'order'                 => [
        ...
        'form_trace_source_title'                     => 'Operación de trazabilidad',
        ...
        'form_item_service_add_name'                  => 'Añadir servicio',
        'form_item_service_fill_win_name'             => 'Rellenar el servicio',
        ...
        'form_table'                            => [
            ...
            'items_count'                      => 'Número de detalles del producto',
            'describe'                         => 'Descripción total',
            'goods'                            => 'Información básica',
            ...
            'address_contact_name'             => 'Contacto de dirección',
            'address_contact_tel'              => 'Dirección número de contacto',
            'address_extraction_contact_name'  => 'Contacto de recogida de dirección',
            'address_extraction_contact_tel'   => 'Dirección para recoger el número de contacto',
            ...
            'currency_code'                    => 'Logotipo monetario',
            'currency_symbol'                  => 'Símbolos monetarios',
            'currency_rate'                    => 'Tipo de cambio de la moneda',
        ...
        'detail_form_list'                      => [
            'items' => [
                'name' => 'Producto del detalle de pedido',
                'data' => [
                    'id'                      => 'ID',
                    'user_id'                 => 'ID de usuario',
                    'order_id'                => 'ID de pedido',
                    'goods_id'                => 'ID de producto',
                    'title'                   => 'Título',
                    'brand_name'              => 'Nombre de marca',
                    'supplier_name'           => 'Nombre de marca',
                    'simple_desc'             => 'Descripción breve del producto',
                    'spec_desc'               => 'Descripción de especificaciones',
                    'images'                  => 'Imágenes de portada',
                    'original_price'          => 'Precio original',
                    'price'                   => 'Precio de venta',
                    'total_price'             => 'Precio total actual (precio unitario * cantidad)',
                    'spec_text'               => 'Especificaciones compradas',
                    'buy_number'              => 'Cantidad comprada',
                    'inventory_unit'          => 'Unidad de inventario',
                    'approval_number'         => 'Número de aprobación',
                    'approval_number_expire'  => 'Fecha de vencimiento del número de aprobación',
                    'batch_number'            => 'Número de lote',
                    'batch_number_expire'     => 'Fecha de vencimiento del número de lote',
                    'coding'                  => 'Código de producto',
                    'model'                   => 'Modelo de producto',
                    'produce_company'         => 'Empresa manufacturera',
                    'produce_region_name'     => 'Lugar de origen',
                    'spec_weight'             => 'Peso de especificación (kg)',
                    'spec_volume'             => 'Volumen de especificación (m³)',
                    'spec_coding'             => 'Código de especificación',
                    'spec_barcode'            => 'Código de barras de especificación',
                    'refund_price'            => 'Monto de reembolso',
                    'returned_quantity'       => 'Cantidad devuelta',
                ],
            ],
            'address_data' => [
                'name' => 'Datos de dirección de pedido',
                'data' => [
                    'id'                       => 'ID',
                    'order_id'                 => 'ID de pedido',
                    'user_id'                  => 'ID de usuario',
                    'address_id'               => 'ID de dirección',
                    'alias'                    => 'Alias de dirección',
                    'name'                     => 'Persona de contacto',
                    'tel'                      => 'Número de teléfono',
                    'province_name'            => 'Provincia',
                    'city_name'                => 'Ciudad',
                    'county_name'              => 'Distrito/Departamento',
                    'address'                  => 'Dirección detallada',
                    'lng'                      => 'Longitud de coordenada',
                    'lat'                      => 'Latitud de coordenada',
                    'appoint_time'             => 'Hora de cita/reserva',
                    'extraction_contact_name'  => 'Persona de contacto para retiro personal',
                    'extraction_contact_tel'   => 'Número de teléfono para retiro personal',
                    'idcard_name'              => 'Nombre en la cédula de identidad',
                    'idcard_number'            => 'Número de cédula de identidad',
                    'idcard_front'             => 'Imagen frontal de la cédula de identidad',
                    'idcard_back'              => 'Imagen trasera de la cédula de identidad',
                ],
            ],
            'express_data' => [
                'name' => 'Datos de mensajería de pedido',
                'data' => [
                    'id'                   => 'ID',
                    'order_id'             => 'ID de pedido',
                    'user_id'              => 'ID de usuario',
                    'express_id'           => 'ID de mensajería',
                    'express_name'         => 'Nombre de mensajería',
                    'express_number'       => 'Número de seguimiento',
                    'express_icon'         => 'Icono de mensajería',
                    'express_website_url'  => 'Sitio web oficial de mensajería',
                ],
            ],
            'service_data' => [
                'name' => 'Datos de servicio de pedido',
                'data' => [
                    'id'                            => 'ID',
                    'order_id'                      => 'ID de pedido',
                    'user_id'                       => 'ID de usuario',
                    'service_name'                  => 'Persona de contacto del servicio',
                    'service_mobile'                => 'Teléfono de contacto del servicio',
                    'service_start_time'            => 'Hora de inicio del servicio',
                    'service_end_time'              => 'Hora de finalización del servicio',
                    'service_duration_minute_text'  => 'Duración del servicio',
                    'note'                          => 'Observaciones',
                ],
            ],
            'extension_data' => [
                'name' => 'Datos extendidos del pedido',
                'data' => [
                    'name'      => 'Nombre',
                    'tips'      => 'Información de sugerencia',
                    'business'  => 'Identificador de negocio',
                ],
            ],
        ],
        // 动态表格统计字段
    ...
    'orderaftersale'        => [
        ...
        'form_table'                            => [
            ...
            'order_no'           => 'Número de pedido',
            'goods_id'           => 'ID de producto',
            'goods_title'        => 'Título de producto',
            'goods_images'       => 'Imagen de portada del producto',
            'goods_price'        => 'Precio de venta del producto',
            'goods_buy_number'   => 'Cantidad comprada del producto',
            'goods_spec_text'    => 'Especificaciones compradas del producto',
            'goods_url'          => 'Dirección de enlace del producto',
            'user_id'            => 'ID de usuario',
            'user_username'      => 'Nombre de usuario',
            'user_nickname'      => 'Apodo de usuario',
            'user_mobile'        => 'Teléfono móvil del usuario',
    ...
    'power'                 => [
        ...
        'export_filename'       => 'Datos de permisos',
        'export_header_title'   => [
            'id'          => 'Datos id',
            'one_name'    => 'Nombre del primer nivel',
            'two_name'    => 'Nombre del segundo nivel',
            'three_name'  => 'Nombre del tercer nivel',
        ],
    ],
    ...
    // form表单
    'forminput'                   => [
        'nav_store_diy_name'                    => 'Descarga de más tableros de formulario',
        'upload_list_tips'                      => [
            '1. Elija el formulario de formulario descargado para diseñar el paquete ZIP',
            '2. La importación agregará automáticamente un nuevo dato',
        ],
        // 动态表格
        'form_table'                            => [
    ...
    'forminputdata'     => [
        // 基础
        'base_nav_title'                        => 'Datos del formulario',
        // 动态表格
        'form_table'                => [
            'user'              => 'Información del usuario',
            'user_placeholder'  => 'Introduzca su nombre de usuario / apodo / teléfono móvil / buzón',
            'forminput_name'    => 'Nombre del formulario',
            'form_data'         => 'Contenido del formulario',
            'add_time'          => 'Añadir tiempo',
            'upd_time'          => 'Tiempo de actualización',
        ],
    ],
    ...
    'errorlog'               => [
        // 动态表格
        'form_table'                            => [
            'message'         => 'Mensaje erróneo',
            'file'            => 'Ruta de archivo incorrecta',
            'line'            => 'Número de línea de archivo incorrecto',
            'code'            => 'Codificación incorrecta',
            'ip'              => 'Solicitar IP',
            'uri'             => 'Segmento de dirección Uri',
            'request_params'  => 'Parámetros de solicitud',
            'memory_use'      => 'usar la memoria',
            'tsc'             => 'Tiempo (segundos)',
            'add_time'        => 'Añadir tiempo',
        ],
    ],
    ...
    'searchhistory'         => [
        ...
        'form_table'                            => [
            ...
            'supplier_text'           => 'marca',
            'category_text'           => 'Clasificación de mercancías',
            'screening_price_values'  => 'Rango de precios',
            'produce_region_text'     => 'Lugar de producción',
            'goods_params_values'     => 'Parámetros de los productos básicos',
            'goods_spec_values'       => 'Especificaciones del producto',
            'order_by_field'          => 'Ordenar Campos',
            'order_by_type'           => 'Tipo de clasificación',
            'search_result'           => 'Resultados de la búsqueda',
            'ip'                      => 'IP del usuario',
            'add_time'                => 'Tiempo de búsqueda',
        ],
    ],
    ...
    'common'                => [
        ...
        'form_goods_params_scope_message'          => 'Por favor, elija el tipo de visualización de los parámetros del producto.',
        ...
        'form_goods_params_value_many_name'        => 'Valor del parámetro (una línea representa un valor opcional)',
        ...
        'form_goods_params_thead_scope_title'      => 'Alcance de la exhibición',
        'form_goods_params_thead_name_title'       => 'Nombre del parámetro',
        'form_goods_params_thead_required_title'   => 'Si es necesario',
        'form_goods_params_thead_data_type_title'  => 'Tipo de datos',
    ...
    'admin_power_menu_list' => [
        ...
        'websiteadmin_index' => [
            ...
            'item'  => [
                ...
                'forminput_index'                  => 'Forma el formulario',
                'forminput_detail'                 => 'Formulario detalles del formulario',
                'forminput_preview'                => 'Formulario vista previa',
                'forminput_saveinfo'               => 'Formulario añadir/editar página',
                'forminput_save'                   => 'Formulario añadir/editar formulario',
                'forminput_statusupdate'           => 'Formulario actualización de estado',
                'forminput_delete'                 => 'Formulario eliminar formulario',
                'forminput_download'               => 'Formulario descargar formulario',
                'forminput_upload'                 => 'Formulario importación de formularios',
                'forminput_market'                 => 'Formulario plantillas marketplace',
                'forminput_storeupload'            => 'Formulario subir tienda',
                'forminput_storeuploadinfo'        => 'Formulario subir página de la tienda',
                'forminputdata_index'              => 'Formulario datos del formulario',
                'forminputdata_detail'             => 'Formulario detalles de datos del formulario',
                'forminputdata_delete'             => 'Formulario eliminación de datos',
                'forminputapi_init'                => 'Form Form Api- inicialización pública',
                'forminputapi_forminputlist'       => 'Formulario Api- lista',
                'forminputapi_forminputdetail'     => 'Formulario Api- detalles',
                'forminputapi_forminputsave'       => 'Formulario Api- guardar',
                'forminputapi_forminputupload'     => 'Formulario Api- importación',
                'forminputapi_forminputdownload'   => 'Formulario Api- exportación',
                'forminputapi_forminputinstall'    => 'Form Form Api- instalación de plantillas',
                'forminputapi_forminputmarket'     => 'Formulario Api- mercado de plantillas',
                ...
                'attachmentapi_index'              => 'Apis para accesorios',
                'attachmentapi_category'           => 'Api de accesorios - clasificación de accesorios',
                'attachmentapi_list'               => 'Accessories Api- lista de accesorios',
                'attachmentapi_save'               => 'Apis de accesorios - conservación de accesorios',
                'attachmentapi_delete'             => 'Apis de accesorios - eliminación de accesorios',
                'attachmentapi_upload'             => 'Adjuntos Api- carga de adjuntos',
                'attachmentapi_catch'              => 'Accessories Api- descarga remota de accesorios',
                'attachmentapi_scanuploaddata'     => 'Adjuntos Api- adjuntos códigos de búsqueda para cargar datos',
                'attachmentapi_movecategory'       => 'Apis de accesorios - clasificación móvil de accesorios',
                'attachmentapi_categorysave'       => 'Api de accesorios - clasificación de accesorios para guardar',
                'attachmentapi_categorydelete'     => 'Api de accesorios - clasificación de accesorios eliminar',
            ]
        ],
        'brand_index' => [
        ...
        'supplier_index' => [
            'name'  => 'Gestión de la marca',
            'item'  => [
                'supplier_index'           => 'Gestión de la marca',
                'supplier_saveinfo'        => 'Página de adición / edición de marca',
                'supplier_save'            => 'Añadir / editar marca',
                'supplier_statusupdate'    => 'Actualización del Estado de la marca',
                'supplier_delete'          => 'Eliminación de la marca',
                'supplier_detail'          => 'Detalles de la marca',
            ]
        ],
        'warehouse_index' => [
        ...
        'app_index' => [
            ...
            'item'  => [
                ...
                'diyapi_apptabbarsave'             => 'Decoración de bricolaje - guardar menú inferior',
                'diyapi_apptabbardata'             => 'Decoración de bricolaje - datos del menú inferior',
